...
namespace Looplex.Foundation.UnitTests.Features.SCIMv2.Entities
{
    ...
    public class ServiceNameProviderTests
    {
        ...
        public void TestSCIMv2WithServiceNameProvider()
        {
            ...
            var scimService = new Looplex.Foundation.SCIMv2.SCIMv2(serviceNameProvider);
        ...
        public void TestMultipleServiceNameProviders()
        {
            ...
            // Act
            var notejamService = new Looplex.Foundation.SCIMv2.SCIMv2(notejamProvider);
            var caseManagementService = new Looplex.Foundation.SCIMv2.SCIMv2(caseManagementProvider);
            var customService = new Looplex.Foundation.SCIMv2.SCIMv2(customProvider);
