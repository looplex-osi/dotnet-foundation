...
public class UserTests
{
  ...
  public void User_MinimalPayload_ShouldDeserializeJson()
  {
    ...
    Assert.IsNotNull(user.Id, "Id should be initialized with default value.");
    Assert.AreEqual(string.Empty, user.Id, "Id should be empty string when not provided.");
...
<User xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"" xmlns:xsd=""http://www.w3.org/2001/XMLSchema"">
  ...
  public void User_FullEnterprisePayload_ShouldDeserializeJsonRoundTrip()
  {
    ...
    Assert.IsTrue(user.Meta.Created != default(DateTime), "Created date/time should be parsed into Meta.");
    Assert.IsTrue(user.Meta.LastModified != default(DateTime), "LastModified date/time should be parsed into Meta.");
