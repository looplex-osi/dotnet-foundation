...
public class AuthenticationsFactoryTests
{
    ...
    {
        // Act
        var result = _factory.GetService(GrantType.TokenExchange);
    ...
    {
        // Act
        var result = _factory.GetService(GrantType.ClientCredentials);
    ...
    {
        // Act & Assert
        var ex = Assert.ThrowsException<ArgumentOutOfRangeException>(() => _factory.GetService((GrantType)999));
