...
[TestClass]
public class SCIMv2GroupsEndpointTests
{
    ...
    [TestMethod]
    public async Task GroupsEndpoint_ValidRequest_ReturnsOk()
    {
        // Act
        var response = await _client.GetAsync("/scim/v2/Groups");
    ...
    [TestMethod]
    public async Task GroupsEndpoint_WithQueryParameters_ReturnsOk()
    {
        // Act
        var response = await _client.GetAsync("/scim/v2/Groups?startIndex=1&count=10");
    ...
    [TestMethod]
    public async Task GroupsEndpoint_WithFilterParameter_ReturnsOk()
    {
        // Act
        var response = await _client.GetAsync("/scim/v2/Groups?filter=displayName eq \"test\"");
    ...
    [TestMethod]
    public async Task GroupsEndpoint_WithSortParameter_ReturnsOk()
    {
        // Act
        var response = await _client.GetAsync("/scim/v2/Groups?sortBy=displayName&sortOrder=ascending");
    ...
    [TestMethod]
    public async Task GroupsEndpoint_PostMethod_ReturnsMethodNotAllowed()
    {
        // Arrange
        var content = new StringContent("{}", System.Text.Encoding.UTF8, "application/scim+json");

        // Act
        var response = await _client.PostAsync("/scim/v2/Groups", content);
    ...
    [TestMethod]
    public async Task GroupsEndpoint_PutMethod_ReturnsMethodNotAllowed()
    {
        // Arrange
        var content = new StringContent("{}", System.Text.Encoding.UTF8, "application/scim+json");

        // Act
        var response = await _client.PutAsync("/scim/v2/Groups", content);
    ...
    [TestMethod]
    public async Task GroupsEndpoint_DeleteMethod_ReturnsMethodNotAllowed()
    {
        // Act
        var response = await _client.DeleteAsync("/scim/v2/Groups");
    ...
    [TestMethod]
    public async Task GroupsEndpoint_ResponseHeaders_AreCorrect()
    {
        // Act
        var response = await _client.GetAsync("/scim/v2/Groups");
    ...
    [TestMethod]
    public async Task GroupsEndpoint_Performance_Under500Milliseconds()
    {
        // Arrange
    ...
    [TestMethod]
    public async Task GroupsEndpoint_ConcurrentRequests_HandlesCorrectly()
    {
        // Arrange
        ...
        for (int i = 0; i < 10; i++)
        {
            tasks.Add(_client.GetAsync("/scim/v2/Groups"));
        }
    ...
    [TestMethod]
    public async Task GroupsEndpoint_ResponseContent_IsValidJson()
    {
        // Act
        var response = await _client.GetAsync("/scim/v2/Groups");
    ...
    [TestMethod]
    public async Task GroupsEndpoint_WithInvalidPath_ReturnsNotFound()
    {
        // Act
        var response = await _client.GetAsync("/scim/v2/Groups/invalid");
    ...
    [TestMethod]
    public async Task GroupsEndpoint_SCIMv2Compliance_ReturnsCorrectSchema()
    {
        // Act
        var response = await _client.GetAsync("/scim/v2/Groups");
