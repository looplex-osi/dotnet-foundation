...
public class SCIMv2 : ISCIMv2, IJsonSchemaProvider, ISCIMv2Validation
{
    ...
    public static Looplex.Foundation.Core.SCIMv2.Entities.ResourceMeta CreateResourceMeta(IDataReader reader, string resourceId, string resourceType)
    {
        // Use fallback URL for static method without HttpContext
        var fullUrl = $"/{resourceType}/{resourceId}";
        return new Looplex.Foundation.Core.SCIMv2.Entities.ResourceMeta
        {
    ...
    public static Looplex.Foundation.Core.SCIMv2.Entities.ResourceMeta CreateResourceMeta(
        IDataReader reader, 
        string resourceId, 
        string resourceType, 
    ...
    public static class ScimFilterProcessor
    {
        ...
        public static (string Sql, Dictionary<string, object> Parameters) ProcessFilter<T>(string filter) where T : IResource
        {
            ...
            var visitor = new Looplex.Foundation.Core.SCIMv2.Entities.SCIMv2ToSQLVisitor();
        ...
        /// <returns>Processed filter parameters with SQL and parameter values</returns>
        public static (string Sql, Dictionary<string, object> Parameters) ProcessFilterWithVisitor(string filter, Looplex.Foundation.Core.SCIMv2.Entities.SCIMv2ToSQLVisitor visitor)
        {
            ...
            try
            {
                ...
                var inputStream = new Antlr4.Runtime.AntlrInputStream(filter);
                var lexer = new Looplex.Foundation.Core.SCIMv2.Antlr.ScimFilterLexer(inputStream);
                var tokenStream = new Antlr4.Runtime.CommonTokenStream(lexer);
                var parser = new Looplex.Foundation.Core.SCIMv2.Antlr.ScimFilterParser(tokenStream);
