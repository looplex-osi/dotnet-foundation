...
public class NoteRepository(IDbConnections connections, ILogger<NoteRepository> logger) : INoteRepository
{
    ...
    private static Looplex.Foundation.SCIMv2.Entities.ResourceMeta CreateResourceMeta(IDataReader reader, string resourceId)
    {
        ...
        {
            ResourceType = "Note",
            Location = $"/notes/{resourceId}",
            Version = "W/\"1\"", // Will be overridden by content-based ETag in SCIMv2 layer
    ...
    {
        // TODO: SearchContent was removed - implement basic filter conversion
        ...
        // TODO: Implement basic filter conversion
