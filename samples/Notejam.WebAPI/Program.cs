...
public static class Program
{
  public static void Main(string[] args)
  {
    ...
    */
    ...
    builder.Services.AddSingleton<Looplex.Foundation.Core.SCIMv2.Modules.IResourceRepository<Note>, Looplex.Samples.Infra.Repositories.NoteRepositoryStoredProcedure>();
    builder.Services.AddSingleton<Looplex.Foundation.Core.SCIMv2.Modules.IResourceRepository<Pad>, Looplex.Samples.Infra.Repositories.PadRepositoryStoredProcedure>();
    ...
    builder.Services.AddSingleton<Looplex.Foundation.Core.SCIMv2.Modules.IResourceService<Note>, SCIMv2NoteService>();
    builder.Services.AddSingleton<Looplex.Foundation.Core.SCIMv2.Modules.IResourceService<Pad>, SCIMv2PadService>();
    ...
    using (var scope = app.Services.CreateScope())
    {
        ...
        var noteService = scope.ServiceProvider.GetRequiredService<Looplex.Foundation.Core.SCIMv2.Modules.IResourceService<Note>>();
        var padService = scope.ServiceProvider.GetRequiredService<Looplex.Foundation.Core.SCIMv2.Modules.IResourceService<Pad>>();
